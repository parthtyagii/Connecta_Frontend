...
const Homepage = () => {
    return (
        <div className='w-screen h-screen box-border flex flex-col justify-start items-start '>
            <Navbar />

            <div className="w-full grow flex justify-center items-center ">

                <div className='w-[45%] h-[100%] p-[2rem] flex gap-y-[4rem] flex-col justify-start items-center '>
                    <div className='w-[60%] mt-[5rem] flex flex-wrap text-[4rem] font-[700] ' >Connect, Collaborate, Conquer!</div>
